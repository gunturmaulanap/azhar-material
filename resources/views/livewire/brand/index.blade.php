<div>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            ...
            {{-- <a href="{{ route('content-admin.brand.form-logo') }}"
                        ...
                        @forelse($brands as $brand)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @else
                                        <div class="h-10 w-10 rounded bg-gray-300 flex items-center justify-center">
                                            <span
                                                class="text-gray-600 font-medium">{{ substr($brand->name, 0, 1) }}</span>
                                        </div>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('content-admin.brand.form-logo.edit', ['id' => $brand->id]) }}"
