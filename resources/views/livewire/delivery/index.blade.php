<div>
    <x-slot name="title">{{ __('Riwayat Pengiriman') }}</x-slot>

    <x-slot name="breadcrumb">
        @php
            $breadcumb = ['Pengiriman', 'Riwayat Pengiriman'];
        @endphp
                        ...
                        <tr class="border-b transition-colors hover:bg-gray-50">
                            ...
                            <td class="py-2">
                                <div class="flex items-center gap-x-4 justify-center">
                                    <a href="{{ route(str_replace('_', '', auth()->user()->role) . '.delivery.detail', ['id' => $item->delivery->id]) }}"
