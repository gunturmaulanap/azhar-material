            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b">
                        ...
                        <th class="h-10 px-2 text-ccenter">
                            <span class="inline-flex font-medium items-center justify-center px-3 text-sm -ml-3">
                                Saldo
                            </span>
                        </th>
                    ...
                    <div class="flex w-full flex-col gap-1">
                        <div class="flex items-center">
                            ...
                            <div class="ml-auto text-xs text-muted-foreground">
                                @if ($item->debt)
                                    <span class="font-extrabold text-sm text-red-600">-@currency($item->debt)</span>
                                @else
                                    <span class="font-extrabold text-sm">@currency($item->balance)</span>
                                @endif
                            </div>
                        </div>
