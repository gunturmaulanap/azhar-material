@section('title', $isEdit ? 'Edit Hero Section' : 'Tambah Hero Section')
...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('content.hero-sections') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-md">
                Kembali
            </a>
        </div>
