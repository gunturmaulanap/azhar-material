        ...
        <div class="flex flex-col sm:flex-row items-center gap-y-3 sm:gap-y-0 sm:gap-x-4 w-full sm:w-fit">
            <div class="flex items-center gap-x-2 sm:gap-x-4 w-full">
                ...
                <select wire:model="statusFilter" id="statusFilter"
                    class="flex rounded-md bg-white border-gray-300 px-3 py-1 sm:w-20 text-sm text-gray-800 shadow-sm transition-colors focus:ring-1 h-8 placeholder:text-xs placeholder:text-slate-600 w-full sm:w-32">
