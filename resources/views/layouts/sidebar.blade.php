    ...
    <nav class="flex flex-col space-y-2 py-6 px-4">
        ...
        @if (auth()->user()->role === 'content-admin')
            ...
            <x-nav-link :href="route('content-admin.hero-sections')" :active="request()->routeIs('content-admin.hero-sections*')">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                    <path fill-rule="evenodd"
                        d="M4.5 5.653c0-1.427 1.529-2.33 2.779-1.643L11.54 6.175a1.85 1.85 0 0 1 .95 1.618v10.414c0 .688-.606 1.232-1.274.894l-4.26-2.165a1.85 1.85 0 0 1-.956-1.618V5.653Z"
                        clip-rule="evenodd" />
                    <path
                        d="M12.25 15.205v-7.41c0-.688.606-1.232 1.274-.894l4.26 2.165c.58.294.956.882.956 1.618v9.655c0 1.427-1.529 2.33-2.779 1.643l-4.261-2.165a1.85 1.85 0 0 1-.95-1.618v-.794Z" />
                </svg>
