...
const Carousel = React.forwardRef<HTMLDivElement, CarouselProps>(
  (
    ...
    const onSelect = React.useCallback((embla: any) => {
      if (!embla) return;
...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, ArrowButtonProps>(
...
const CarouselNext = React.forwardRef<HTMLButtonElement, ArrowButtonProps>(
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
