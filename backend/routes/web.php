...
// Customer routes (Livewire) - unified routing for both guards
...
Route::middleware(['auth:web', 'role:customer'])->group(function () {
    Route::get('/customer/detail-transaksi/{id}', App\Http\Livewire\Transaction\Detail::class)->name('customer.transaction.detail.web');
    Route::get('/customer/pengiriman-barang/{id}', App\Http\Livewire\Delivery\Detail::class)->name('customer.delivery.detail.web');
});
