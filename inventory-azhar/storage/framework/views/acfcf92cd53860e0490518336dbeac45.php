<div>
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('Detail Transaksi')); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:justify-between">
        <h2 class="text-2xl font-semibold tracking-tight"><?php echo e($transaction->name); ?></h2>
        <div class="sm:max-w-xs sm:text-right mt-3 sm:mt-0">
            <span class="text-md"><?php echo e($transaction->phone); ?></span><br>
            <span class="text-sm text-gray-500"><?php echo e($transaction->address); ?></span>
        </div>
    </div>
    ...
    <div class="flex flex-col sm:flex-row items-end sm:justify-between mt-6">
        ...
        <div class="flex gap-4 w-full sm:w-fit">
            <?php if(in_array(auth()->user()->role, ['super_admin', 'admin'])): ?>
                <?php if(isset($transaction->delivery->id)): ?>
                    <a href="<?php echo e(route('delivery.detail', ['id' => $transaction->delivery->id])); ?>"
            ...
            <?php else: ?>
                <?php if(isset($transaction->delivery->id)): ?>
                    <a href="<?php echo e(route('customer.delivery.detail', ['id' => $transaction->delivery->id])); ?>"
                        class="flex items-center gap-x-2 rounded-md bg-yellow-300 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-yellow-400 mb-6">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div class="rounded-md border bg-white mt-4 max-h-96 overflow-auto">
                                    <div class="relative w-full overflow-auto">
                                        <table class="w-full text-sm whitespace-nowrap">
                                            ...
                                            <?php if(count($returTransactions) > 0): ?>
                                                <tbody>
                                                    <?php $__currentLoopData = $returTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $retur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr class="border-b transition-colors hover:bg-gray-50">
                                                            <td class="p-2 px-4 w-[20%]"><?php echo e($retur->goods->name); ?></td>
                                                            <td class="p-2 text-center">Rp. <?php echo number_format($retur->price,0,',','.'); ?></td>
                                                            <td class="p-2 text-center"><?php echo e($retur->retur_qty); ?>

                                                                <?php echo e($retur->goods->unit); ?></td>
                                                            <td class="p-2 text-center">Rp. <?php echo number_format($retur->subcashback,0,',','.'); ?></td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            <?php endif; ?>
        ...
        <div class="relative w-full overflow-auto">
            <table class="w-full text-sm whitespace-nowrap">
                ...
                <tbody class="border-b">
                    <?php $__currentLoopData = $transaction->goods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $good): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($good->pivot->qty > 0): ?>
                            <tr>
                                <td class="p-4 px-0">
                                ...
                                <td class="p-4 text-center">
                                    Rp. <?php echo number_format($good->pivot->price,0,',','.'); ?>
                                </td>
                                <td class="p-4 text-center capitalize">
                                    <?php echo e($good->pivot->qty); ?> <?php echo e($good->unit); ?>

                                </td>
                                <td class="p-4 text-center">
                                    <?php if($good->pivot->delivery): ?>
                                        <?php echo e(\App\Models\DeliveryGoods::where('goods_id', $good->id)->whereHas('delivery', function ($query) use ($transaction) {
                                ...
                                <td class="px-4 text-right">
                                    Rp. <?php echo number_format($good->pivot->subtotal,0,',','.'); ?>
                                </td>
                            </tr>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div x-data="{ open: false }" class="grid grid-cols-1 sm:grid-cols-7 mt-4">
            <div class="sm:col-span-4">
                ...
                <div class="grid py-3 grid-cols-2 sm:grid-cols-3 text-end sm:text-start">
                    ...
                    <dd
                        class="<?php if($transaction->status !== 'selesai'): ?> text-yellow-600 <?php else: ?> text-green-600 <?php endif; ?> capitalize">
                        <?php echo e($transaction->status); ?></dd>
                </div>
                    ...
                    <div x-show="open" class="fixed inset-0 flex items-center justify-center z-50"
                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all w-auto">
                            <div class="flex items-center justify-center p-6">
                                <img src="<?php echo e(asset('storage/' . $transaction->image)); ?>" alt="Image Preview"
                                    class="mt-2 w-80 object-contain object-center">
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                <?php if($transaction->actDebts->count() > 0): ?>
                    ...
                    <ol class="flex flex-col mt-2 items-start gap-2 text-sm font-medium text-gray-500">
                        <?php $__currentLoopData = $transaction->actDebts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex items-center justify-center gap-2">
                                <span
                                    class="px-2 py-0.5 rounded bg-blue-50 text-center text-sm font-bold text-blue-600">
                                    Rp. <?php echo number_format($act->pay,0,',','.'); ?>
                                </span>

                                <span>Telah dibayarkan pada
                                    <?php echo e(\Carbon\Carbon::parse($act->created_at)->translatedFormat('d F Y')); ?></span>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ol>
                <?php endif; ?>
            ...
            <div class="sm:col-start-6 sm:col-span-2">
                <div class="grid py-3 grid-cols-2 gap-4 text-end">
                    ...
                    <dd class="font-extrabold text-gray-900">Rp. <?php echo number_format($transaction['total'],0,',','.'); ?></dd>
                </div>
                <?php if($transaction['discount'] > 0): ?>
                    <div class="grid py-3 grid-cols-2 gap-4 text-end">
                        <dt class="font-light text-gray-900">Potongan</dt>
                        <dd class="text-gray-700">Rp. <?php echo number_format($transaction['discount'],0,',','.'); ?></dd>
                    </div>
                <?php endif; ?>
                <?php if($transaction['balance'] > 0): ?>
                    <div class="grid py-3 grid-cols-2 gap-4 text-end">
                        <dt class="font-light text-gray-900">Saldo</dt>
                        <dd class="text-gray-700">Rp. <?php echo number_format($transaction['balance'],0,',','.'); ?></dd>
                    </div>
                <?php endif; ?>
                <?php if($transaction['grand_total'] > 0 && $transaction['grand_total'] !== $transaction['total']): ?>
                    <div class="grid py-3 grid-cols-2 gap-4 text-end">
                        <dt class="font-extrabold text-gray-950">Grand total</dt>
                        <dd class="font-extrabold text-gray-900">Rp. <?php echo number_format($transaction['grand_total'],0,',','.'); ?></dd>
                    </div>
                <?php endif; ?>
                <?php if($transaction['balance'] - ($transaction['total'] - $transaction['discount']) > 0): ?>
                    <div class="grid py-3 grid-cols-2 gap-4 text-end">
                        <dt class="font-light text-gray-900">Sisa saldo</dt>
                        <dd class="text-gray-700">Rp. <?php echo number_format($transaction['balance'] - ($transaction['total'] - $transaction['discount']),0,',','.'); ?></dd>
                    </div>
                <?php endif; ?>
                <?php if($transaction['bill'] > 0): ?>
                    <div class="grid py-3 grid-cols-2 gap-4 text-end">
                        <dt class="font-light text-gray-900">Bayar</dt>
                        <dd class="text-gray-700">Rp. <?php echo number_format($transaction['bill'],0,',','.'); ?></dd>
                    </div>
                <?php endif; ?>
                <?php if($transaction['return'] !== 0): ?>
                    <div class="grid py-3 grid-cols-2 gap-4 text-end">
                        <dt class="font-light <?php echo e($transaction['return'] > 0 ? 'text-gray-900' : 'text-red-700'); ?>">
                            <?php echo e($transaction['return'] > 0 ? 'Kembalian' : 'Kurang'); ?>

                        </dt>
                        <dd class="<?php echo e($transaction['return'] > 0 ? 'text-gray-700' : 'text-red-600'); ?>">
                            Rp. <?php echo number_format(abs($transaction['return']),0,',','.'); ?>
                        </dd>
                    </div>
                <?php endif; ?>
                <?php if(auth()->user()->role === 'super_admin'): ?>
                    <?php if($transaction['status'] == 'hutang' && $transaction['total'] > 0 && $transaction['return'] < 0): ?>
                                                ...
                                                <div class="grid p-3 grid-cols-3 gap-4">
                                                    ...
                                                    <dd class="text-gray-700 col-span-2">
                                                        <input wire:model="input.bill" type="number" id="bill"
                                                            ...
                                                            min="0"
                                                            oninput="this.value = Math.min(Math.abs(this.value), <?php echo e(abs((int) $transaction['return'])); ?>);" />
                                                    </dd>
                                                </div>
                                            </dl>
                                        </div>
    ...
    <?php if(in_array(auth()->user()->role, ['super_admin', 'admin'])): ?>
        ...
        <div x-data="{ modal: false }" class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <a href="<?php echo e(route('transaction.mini-invoice', ['id' => $transaction->id])); ?>" target="_blank"
                class="text-sm font-semibold">Nota kecil</a>
            <a href="<?php echo e(route('transaction.invoice', ['id' => $transaction->id])); ?>" target="_blank"
                        ...
                        <div class="rounded-md border bg-white mt-4 max-h-96 overflow-auto">
                            <div class="relative w-full overflow-auto">
                                <table class="w-full text-sm whitespace-nowrap">
                                    ...
                                    <tbody class="border-b">
                                        <?php $__currentLoopData = $transaction->goods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $good): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($good->pivot->qty !== 0): ?>
                                                <tr>
                                                    <td class="p-4">
                                                        <?php echo e($good->name); ?>
                                                    ...
                                                    <td>
                                                        <div class="flex items-center justify-center gap-x-2">
                                                            <div
                                                                ...
                                                                <button type="button"
                                                                    wire:click="decrement(<?php echo e($index); ?>)"
                                                                    class="size-10 leading-10 text-gray-600 transition hover:opacity-75">
                                                                    &minus;
                                                                </button>

                                                                <input type="text"
                                                                    id="retur_qty-<?php echo e($index); ?>"
                                                                    wire:model="returGoods.<?php echo e($index); ?>.retur_qty"
                                                                ...
                                                                <button type="button"
                                                                    wire:click="increment(<?php echo e($index); ?>)"
                                                                    class="size-10 leading-10 text-gray-600 transition hover:opacity-75">
                                                                    &plus;
                                                                </button>
                                                            </div>
                                                    ...
                                                    <td class="px-4 text-center">
                                                        Rp. <?php echo number_format($good->pivot->price * ($returGoods[$index]['retur_qty'] ?? 0),0,',','.'); ?>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="grid grid-cols-7 mt-2">
                                <div class="col-span-7 sm:col-start-6 sm:col-span-2">
                                    <div class="grid py-3 grid-cols-2 gap-4 text-end sm:mr-4">
                                        ...
                                        <dd class="text-gray-700">Rp. <?php echo number_format($total,0,',','.'); ?></dd>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/gunturmaulana/inventory-azhar/resources/views/livewire/transaction/detail.blade.php ENDPATH**/ ?>