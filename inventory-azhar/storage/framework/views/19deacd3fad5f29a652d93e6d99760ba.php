                ...
                <div class="flex justify-between sm:h-16">
                    <div class="flex items-center text-white">
                        ...
                        <div class="shrink-0 flex items-center">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('customer.detail', ['id' => Auth::guard('customer')->user()->id])); ?>"
                                    class="text-2xl uppercase tracking-widest font-[1000] subpixel-antialiased">
                                    <?php echo e(__('inventory')); ?>
...
<?php endif; ?>
                    ...
                    <div class="max-w-7xl mx-auto sm:flex items-center py-6 px-4 sm:px-8 divide-x">
                        ...
                        <nav aria-label="Breadcrumb" class="ps-4 sm:ps-6">
                            <ol class="flex items-center gap-1 text-sm text-gray-600">
                                <li>
                                    <a href="<?php echo e(route('dashboard')); ?>" class="block transition hover:text-gray-900">
        ...
        <?php echo $__env->make('layouts.js.alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /Users/gunturmaulana/inventory-azhar/resources/views/layouts/app.blade.php ENDPATH**/ ?>