<div>
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('Data Order')); ?> <?php $__env->endSlot(); ?>
                        ...
                        <tr class="border-b transition-colors hover:bg-gray-50">
                            ...
                            <td class="py-2">
                                <div class="flex items-center gap-x-4 justify-center">
                                    <a href="<?php echo e(route('order.detail', ['id' => $item->id])); ?>"
        ...
        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button class="flex flex-col items-start gap-2 rounded-lg border p-3 text-left text-sm w-full">
                <div class="flex w-full flex-col gap-1">
                    <div class="text-lg font-semibold"><?php echo e($item->supplier->company); ?></div>
                </div>
...
<?php /**PATH /Users/gunturmaulana/inventory-azhar/resources/views/livewire/order/index.blade.php ENDPATH**/ ?>