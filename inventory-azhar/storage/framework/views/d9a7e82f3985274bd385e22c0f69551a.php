<div>
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('Riwayat Transaksi')); ?> <?php $__env->endSlot(); ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b transition-colors hover:bg-gray-50">
                            ...
                            <td
                                class="p-2 text-center capitalize <?php if($item->status !== 'selesai'): ?> text-yellow-600 <?php else: ?> text-green-600 <?php endif; ?>">
                                <?php echo e($item->status); ?>

                            </td>
                            <td class="p-2 text-center">
                                <span class="capitalize"><?php echo e($item->delivery->status ?? ''); ?></span>
                            </td>
                            ...
                            <td class="py-2">
                                <div class="flex items-center gap-x-4 justify-center">
                                    <a href="<?php echo e(route('transaction.detail', ['id' => $item->id])); ?>"
                                    ...
                                    <?php if($item->status == 'draft'): ?>
                                        <a href="<?php echo e(route('master.update-customer', ['id' => $item->id])); ?>"
        ...
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button class="flex flex-col items-start gap-2 rounded-lg border p-3 text-left text-sm w-full">
                <div class="flex w-full flex-col gap-1">
                    <div class="text-lg font-semibold"><?php echo e($item->name); ?></div>
                </div>
                <div class="flex items-center justify-between text-sm w-full pb-2 border-b border-slate-100">
                    ...
                    <span><?php echo e(\Carbon\Carbon::parse($item->created_at)->translatedFormat('d F Y')); ?></span>
                </div>
                <div class="flex items-center justify-between text-sm w-full pb-2 border-b border-slate-100">
                    <span class="text-gray-700">Jumlah Barang</span>
                    <span><?php echo e($item->goods()->count()); ?> Barang <span
                            class=" text-yellow-600"><?php echo e($item->delivery->status ?? ''); ?></span></span>
                </div>
                <div class="flex items-center justify-between text-sm w-full pb-2 border-b border-slate-100">
                    <span>Tagihan</span>
                    <span class="font-bold">Rp. <?php echo number_format($item->total,0,',','.'); ?></span>
                </div>
                <div class="flex items-center justify-between text-sm w-full pb-2 border-b border-slate-100">
                    <span>Status</span>
                    <?php if($item->status == 'selesai'): ?>
                        <span class="font-normal capitalize text-green-600"><?php echo e($item->status); ?></span>
                    <?php else: ?>
                        <span class="font-normal capitalize text-yellow-600"><?php echo e($item->status); ?></span>
                    <?php endif; ?>
                </div>
...
<?php /**PATH /Users/gunturmaulana/inventory-azhar/resources/views/livewire/transaction/history.blade.php ENDPATH**/ ?>