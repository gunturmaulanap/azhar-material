<div>
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('Transaksi')); ?> <?php $__env->endSlot(); ?>
            ...
            <?php if($customer == true): ?>
                <div x-data="{ open: false }" x-init="open = false"
                    ...
                    <div class="col-span-7 sm:col-span-4">
                        ...
                        <?php if($errors->has('transaction.name')): ?>
                            <span class="text-xs text-red-500"><?php echo e($errors->first('transaction.name')); ?></span>
                        <?php else: ?>
                            ...
                            <div class="p-6">
                                ...
                                <div class="rounded-md border-0 sm:border bg-white mt-4 max-h-96 overflow-auto">
                                                ...
                                                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr wire:click="setCustomer(<?php echo e($item->id); ?>)"
                                                        ...
                                                        <td class="p-2 text-nowrap text-center">
                                                            Rp. <?php echo number_format($item->balance,0,',','.'); ?>
                                                        </td>
                                                        <td class="p-2 text-nowrap text-center">
                                                            Rp. <?php echo number_format($item->debt,0,',','.'); ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
                                    ...
                                    <div class="space-y-3 sm:hidden" @click="open = false">
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div wire:click="setCustomer(<?php echo e($item->id); ?>)"
                                                ...
                                                <div class="flex w-full flex-col gap-1">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="ml-auto text-xs text-muted-foreground">
                                                            <?php if($item->debt): ?>
                                                                <span
                                                                    class="font-extrabold text-sm text-red-600">-Rp. <?php echo number_format($item->debt,0,',','.'); ?></span>
                                                            <?php else: ?>
                                                                <span
                                                                    class="font-extrabold text-sm">Rp. <?php echo number_format($item->balance,0,',','.'); ?></span>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                    <div class="text-xs font-medium"><?php echo e($item->phone); ?></div>
                                                </div>
                    ...
                    <div class="col-span-7 sm:col-span-4">
                        ...
                        <div class="mt-2" x-data="{ phone: <?php if ((object) ('transaction.phone') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('transaction.phone'->value()); ?>')<?php echo e('transaction.phone'->hasModifier('defer') ? '.defer' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('transaction.phone'); ?>')<?php endif; ?> }">
                            ...
                            <?php $__errorArgs = ['transaction.phone'];
                ...
                <div class="relative w-full overflow-auto hidden sm:block">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="border-b">
                            <?php $__empty_1 = true; $__currentLoopData = $goodTransaction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="p-4 px-2 text-center">
                                        <div class="flex items-center justify-center text-center">
                                            <div class="relative mt-2 rounded-md shadow-sm bg-blue-500">
                                                ...
                                                <input type="text" id="price-<?php echo e($index); ?>"
                                                    wire:model="goodTransaction.<?php echo e($index); ?>.price"
                                        ...
                                        <div class="flex items-center justify-center gap-x-2">
                                            <div class="flex items-center rounded border border-gray-200">
                                                ...
                                                <input type="number" id="qty-<?php echo e($index); ?>"
                                                    wire:model="goodTransaction.<?php echo e($index); ?>.qty"
                                    ...
                                    <td class="p-2">
                                        <div class="flex justify-center items-start gap-x-2">
                                            <div class="flex h-6 items-center">
                                                <input id="delivery<?php echo e($index); ?>" type="checkbox"
                                                    wire:model="goodTransaction.<?php echo e($index); ?>.delivery"
                                                    <?php if(!$customer): ?> disabled <?php endif; ?>
                                                    class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                            </div>
                                            <div class="text-sm leading-6">
                                                <label for="delivery<?php echo e($index); ?>"
                        ...
                        <div class="flex flex-col items-start gap-3 rounded-lg border p-3 text-left text-sm w-full">
                            ...
                            <div class="grid grid-cols-3 items-center justify-between w-full">
                                ...
                                <div class="col-span-2 w-full relative mt-2 rounded-md shadow-sm">
                                    ...
                                    <input type="number" id="price-<?php echo e($index); ?>"
                                        wire:model="goodTransaction.<?php echo e($index); ?>.price"
                                ...
                                <div class="col-span-2 flex gap-3">
                                    <div class="flex h-6 shrink-0 items-center">
                                        <div class="group grid size-4 grid-cols-1">
                                            <input id="delivery<?php echo e($index); ?>"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-7 mt-4">
                    ...
                    <div class="col-span-1 sm:col-start-4 sm:col-span-4 xl:col-start-5 xl:col-span-3 mt-4 sm:mt-0">
                        <div class="grid py-3 grid-cols-3 sm:grid-cols-2 gap-4 text-end">
                            ...
                            <dd class="col-span-2 sm:col-span-1 font-extrabold text-gray-900 mr-4">Rp. <?php echo number_format($transaction['total'] ?? 0,0,',','.'); ?>
                            </dd>
                        </div>
                        <div class="grid py-3 grid-cols-3 sm:grid-cols-2 gap-4 text-end">
                        ...
                        <?php if(isset($transaction['balance'])): ?>
                            <?php if($transaction['balance'] > 0): ?>
                                <div class="grid py-3 grid-cols-3 sm:grid-cols-2 gap-4 text-end">
                                    <dt class="text-start sm:text-end font-light text-gray-900">Saldo</dt>
                                    <dd class="col-span-2 sm:col-span-1 text-gray-700 mr-4">Rp. <?php echo number_format($transaction['balance'] ?? 0,0,',','.'); ?></dd>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if(isset($transaction['balance'])): ?>
                            <?php if($transaction['balance'] < $transaction['total']): ?>
                                <div class="grid py-3 grid-cols-3 sm:grid-cols-2 gap-4 text-end">
                                    ...
                                    <dd class="col-span-2 sm:col-span-1 font-extrabold text-gray-900 mr-4">
                                        Rp. <?php echo number_format($transaction['grand_total'] ?? 0,0,',','.'); ?></dd>
                                </div>
                            <?php endif; ?>
                            <?php if(isset($transaction['total']) &&
                                ...
                                <div class="grid py-3 grid-cols-3 sm:grid-cols-2 gap-4 text-end">
                                    ...
                                    <dd class="col-span-2 sm:col-span-1 text-gray-700 mr-4">Rp. <?php echo number_format($balance,0,',','.'); ?></dd>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if(isset($transaction['balance'])): ?>
                            <?php if($transaction['balance'] < $transaction['total'] || $transaction['balance'] <= 0): ?>
                                <div class="grid py-3 grid-cols-3 sm:grid-cols-2 gap-4 text-end">
                                ...
                                <?php if(isset($transaction['return'])): ?>
                                    <div class="grid py-3 grid-cols-3 sm:grid-cols-2 gap-4 text-end">
                                        <dt
                                            class="font-medium text-start sm:text-end <?php echo e($transaction['return'] > 0 ? 'text-gray-900' : 'text-red-700'); ?>">
                                            <?php echo e($transaction['return'] > 0 ? 'Kembalian' : 'Kurang'); ?>

                                        </dt>
                                        <dd
                                            class="col-span-2 sm:col-span-1 <?php echo e($transaction['return'] > 0 ? 'text-gray-700' : 'text-red-600'); ?> mr-4">
                        ...
                        <?php else: ?>
                            ...
                            <?php if(isset($transaction['return'])): ?>
                                <div class="grid py-3 grid-cols-3 sm:grid-cols-2 gap-4 text-end">
                                    <dt
                                        class="text-start sm:text-end font-medium <?php echo e($transaction['return'] > 0 ? 'text-gray-900' : 'text-red-700'); ?>">
                                        <?php echo e($transaction['return'] > 0 ? 'Kembalian' : 'Kurang'); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/gunturmaulana/inventory-azhar/resources/views/livewire/transaction/create.blade.php ENDPATH**/ ?>