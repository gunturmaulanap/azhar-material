<div>
     <?php $__env->slot('title', null, []); ?> <?php echo e(__('Data Hutang')); ?> <?php $__env->endSlot(); ?>

     <?php $__env->slot('breadcrumb', null, []); ?> 
        <?php
            $breadcumb = ['Data Hutang'];
        ?>
    ...
    <div class="rounded-md border bg-white hidden sm:block">
        <div class="relative w-full overflow-auto">
            <table class="w-full text-sm whitespace-nowrap">
                <thead>
                    <tr class="border-b">
                        <th class="h-10  my text-left p-2 px-4 w-[15%]">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b transition-colors hover:bg-gray-50">
                            ...
                            <td class="p-2 text-center">
                                ...
                                <?php else: ?>
                                    Rp. <?php echo number_format($item->grand_total,0,',','.'); ?>
                                <?php endif; ?>
                            </td>
                            <td
...
<?php /**PATH /Users/gunturmaulana/inventory-azhar/resources/views/livewire/debt/index.blade.php ENDPATH**/ ?>